...
+ (BMGIFManager *)shared;
- (void)stopGIFView:(BMGIFImageView *)view;
@end
...
- (void)play
{
    for (BMGIFImageView *imageView in _gifViewHashTable)
    {
